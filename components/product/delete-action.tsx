...
export function DeleteAction({ expenseId }: { expenseId: string }) {
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent className="sm:max-w-[450px] p-6">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Расход исчезнет из вашего списка. Импортированная история платежей
              сохранится. Это не отменяет услугу у поставщика.
            </AlertDialogDescription>
          </AlertDialogHeader>
          {error && (
